...
import AdminAnnouncements from "@/components/ui/admin/AdminAnnouncements"; // ✅ เพิ่ม component จัดการข่าวสาร
  ...
  return (
    <div className={rootClass}>
      ...
      <main className="main">
        ...
        {/* ✅ ส่วน Welcome Section (ข้อความหัว + วันที่/เวลา) */}
        <WelcomeSectionAdmin_news />

        {/* ✅ ส่วนจัดการข่าวสาร (AdminAnnouncements) */}
