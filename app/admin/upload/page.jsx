...
import WelcomeSectionAdmin_upload from "@/components/ui/admin/WelcomeSectionAdmin_upload";
import AdminUploadBox from "@/components/ui/admin/AdminUploadBox"; // ✅ เพิ่ม component อัปโหลด
  ...
  return (
    <div className={rootClass}>
      ...
      <main className="main">
        ...
        <WelcomeSectionAdmin_upload />

        {/* ✅ เพิ่ม Components อัปโหลด */}
        <AdminUploadBox />
      </main>
